...
DROP POLICY IF EXISTS "Staff competencies: authenticated read" ON public.staff_competencies;
CREATE POLICY "Staff competencies: authenticated read"
  ON public.staff_competencies FOR SELECT TO authenticated USING (true);

DROP POLICY IF EXISTS "Staff competencies: authenticated write" ON public.staff_competencies;
...
DROP POLICY IF EXISTS "Competency reference: authenticated read" ON public.competency_reference;
