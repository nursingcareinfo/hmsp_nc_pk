...
- Name: features/market-research.spec.ts >> Patient Service Category >> should display Add Patient form with clinical metadata fields
- Location: tests/e2e/features/market-research.spec.ts:68:3
...
Call log:
  - waiting for locator('text=Patients')
...
> 64  |     await page.click('text=Patients')
  ...
  112 |     await page.click('text=Market Analysis')
  113 |     await page.waitForLoadState('networkidle')
  114 | 
  115 |     const searchInput = page.locator('input[placeholder*="Home care nursing"]')
