            ...
            <div className="bg-white/95 backdrop-blur-sm p-6 rounded-[30px] flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-sm font-black text-teal-900 uppercase tracking-widest">NursingCare Live AI</h3>
                  <div className="px-2 py-0.5 bg-emerald-100 text-emerald-600 rounded-full text-[10px] font-bold uppercase animate-pulse">Live Feed</div>
                </div>
                {isGenerating ? (
                  ...
                  <p className="text-sm text-slate-500 italic">Waiting for live data stream...</p>
                )}
              </div>
              <button 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-lg font-bold text-slate-900">Live Staff Feed</h3>
            <button 
